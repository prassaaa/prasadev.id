...
const filters: { value: 'all' | Project['category']; label: string }[] = [
  ...
  ...Array.from(
    new Map(projects.map((project) => [project.category, project.categoryLabel])),
    ...
    <section id="portfolio" className="section-shell bg-muted">
      <div className="site-container">
        <div className="mb-10 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <SectionHeading label={site.portfolio.eyebrow} accent="lime" className="mb-0 max-w-xl">
        ...
        <div id="portfolio-grid" className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          <AnimatePresence initial={false}>
            {visibleProjects.map((project) => (
              <motion.div
                ...
                className="min-w-0 [&>article]:h-full">
