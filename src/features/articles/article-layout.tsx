        ...
        <div className="site-container">
          <nav aria-label="Breadcrumb" className="mb-10 font-mono text-xs text-muted-foreground">
            <ol className="flex flex-wrap items-center gap-2">
              ...
              <li>
                <Link className="underline underline-offset-4" to="/artikel">
                  Artikel
                </Link>
              </li>
              <li aria-hidden="true">/</li>
          ...
          <div className="mt-12 border-t-2 border-border pt-10">
            <div className="article-prose max-w-[72ch] min-w-0">{children}</div>
          </div>
          <footer className="mt-12 max-w-[72ch] space-y-10">
            ...
            <div className="border-2 border-border bg-card p-6 shadow-neo-cyan sm:p-8">
              ...
              <p className="mt-3 mb-6 leading-relaxed text-muted-foreground">
                Ceritakan kebutuhan aplikasi atau peluang kerja yang ingin Anda diskusikan.
              </p>
              <Button asChild className="h-auto py-3 whitespace-normal">
                <Link to="/#contact">
                  Lihat kanal kontak <ArrowUpRight aria-hidden="true" />
                </Link>
              </Button>
            </div>
          </footer>
