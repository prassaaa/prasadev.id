        ...
        <div className="site-container">
          <div className="max-w-3xl border-2 border-border bg-card p-6 shadow-neo sm:p-10">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Alamat yang Anda buka tidak tersedia. Kembali ke beranda untuk melihat profil dan
              proyek saya.
            </p>
            <div className="mt-8 flex flex-wrap gap-4">
              <Button asChild>
                <Link to="/">
                  <ArrowLeft aria-hidden="true" /> Ke beranda
                </Link>
              </Button>
              <Button asChild variant="outline">
                <Link to="/#portfolio">
                  <BookOpen aria-hidden="true" /> Lihat Proyek
                </Link>
              </Button>
            </div>
          </div>
