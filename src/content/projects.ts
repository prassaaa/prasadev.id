...
export const projects: Project[] = [
  {
    ...
    description: 'Saya mengembangkan SIMRS berbasis web untuk data pasien, rekam medis, dan administrasi, serta aplikasi Android yang terhubung dengan backend API.',
    context: 'Rumah Sakit Bhayangkara Kediri melayani anggota kepolisian, keluarga, dan masyarakat umum. Pekerjaan saya mencakup sistem web dan aplikasi mobile untuk kebutuhan layanan rumah sakit.',
    contributions: [
    ...
    features: ['Data pasien dan rekam medis', 'Administrasi rumah sakit', 'Validasi stok dan kontrol transaksi', 'Sinkronisasi data aplikasi Android melalui API'],
    tags: ['Android', 'API'],
    image: { src: '/assets/project-1.jpg', alt: 'Ilustrasi sementara untuk proyek sistem rumah sakit' },
  },
  {
    ...
    description: 'Saya mengembangkan sistem Laravel–React dengan dashboard analitik, pelaporan real-time, validasi stok, dan kontrol transaksi untuk kebutuhan operasional Innapack.',
    context: 'Innapack adalah perusahaan manufaktur kemasan fleksibel berbasis film LLDPE di Cikarang. Sistem dikembangkan secara modular untuk kebutuhan operasional tiap divisi.',
    contributions: [
    ...
    tags: ['Laravel', 'React'],
    image: { src: '/assets/project-2.jpg', alt: 'Ilustrasi sementara untuk proyek sistem operasional manufaktur' },
  },
  {
    ...
    description: 'Saya mengembangkan sistem koperasi berbasis Laravel dan aplikasi Flutter untuk layanan anggota, transaksi simpan pinjam, serta laporan keuangan.',
    context: 'Sistem Koperasi Merah Putih dikembangkan untuk kebutuhan Dinas Koperasi dan Usaha Mikro Kabupaten Tangerang. Website dan aplikasi mobile terhubung melalui API Laravel.',
    contributions: [
    ...
    features: ['Manajemen anggota', 'Transaksi simpan pinjam', 'Laporan keuangan', 'Akses layanan anggota melalui aplikasi mobile'],
    tags: ['Laravel', 'Flutter', 'RESTful API'],
    image: { src: '/assets/project-3.jpg', alt: 'Ilustrasi sementara untuk proyek aplikasi koperasi' },
  },
  {
    ...
    description: 'Saya membangun sistem pemesanan ambulans dan kampanye donasi dari awal, termasuk API penjadwalan serta integrasi payment gateway nasional.',
    context: 'Yayasan Wahdah Inisiatif Kebaikan di Bandung bergerak di bidang kemanusiaan dan pemberdayaan lingkungan. Pekerjaan ini mencakup layanan pemesanan ambulans dan penggalangan dana online.',
    contributions: [
    ...
    features: ['Pemesanan dan penjadwalan ambulans', 'Antarmuka pengguna dan admin', 'Publikasi kampanye donasi', 'Pembayaran donasi online'],
    tags: ['API', 'Payment Gateway'],
    image: { src: '/assets/project-4.jpg', alt: 'Ilustrasi sementara untuk proyek layanan ambulans dan donasi' },
  },
  {
    ...
    description: 'Saya mengembangkan website profil perusahaan, chatting internal real-time, manajemen inventaris, dan sistem kasir web yang terintegrasi dengan stok.',
    context: 'PT. ASM Tunas Muda di Batam bergerak di bidang teknologi informasi. Kontribusi saya mencakup beberapa aplikasi web untuk profil perusahaan, komunikasi internal, persediaan, dan transaksi.',
    contributions: [
    ...
    features: ['Profil, layanan, galeri proyek, dan formulir inquiry', 'Chatting internal real-time', 'Manajemen dan laporan stok', 'Kasir web terintegrasi inventaris'],
    tags: ['Socket'],
    image: { src: '/assets/project-5.jpg', alt: 'Ilustrasi sementara untuk proyek aplikasi operasional perusahaan' },
  },
  {
    ...
    description: 'Saya mengembangkan dan memelihara website resmi dinas untuk informasi destinasi wisata dan kegiatan kebudayaan, dengan kalender event, galeri, serta layanan publik.',
    context: 'Website Dinas Pariwisata dan Kebudayaan Kabupaten Kediri menjadi media informasi wisata, kebudayaan, dan komunikasi layanan kepada masyarakat.',
    contributions: [
    ...
    features: ['Informasi destinasi wisata dan kebudayaan', 'Kalender event', 'Galeri multimedia', 'Reservasi tur dan formulir layanan publik'],
    tags: [],
    image: { src: '/assets/project-6.jpg', alt: 'Ilustrasi sementara untuk proyek website pariwisata' },
  },
  {
    ...
    description: 'Saya membangun website BUMDes Wonorejo dengan informasi usaha dan kegiatan desa, manajemen produk UMKM, serta sistem pemesanan sederhana.',
    context: 'BUMDes Wonorejo mengelola usaha desa dan layanan masyarakat. Website dikembangkan bersama pengurus BUMDes dan perangkat desa untuk mendukung kebutuhan usaha dan informasi publik.',
    contributions: [
    ...
    features: ['Berita desa dan profil usaha', 'Laporan kegiatan dan kontak layanan', 'Manajemen produk UMKM', 'Pemesanan sederhana'],
    tags: [],
